...
( function() {
	...
	CKEDITOR.plugins.a11ychecker.quickFixes.get( { langCode: 'fr',
		...
		callback: function( QuickFix ) {
			...
			ImgAlt.prototype.lang = {"altLabel":"Text alternatif","errorTooLong":"Le texte alternatif est trop long. Il ne doit pas dépasser {limit} caractères alors que vous en avez {length}","errorWhitespace":"Le texte alternatif ne peut pas contenir que des espaces","errorSameAsFileName":"Le text ne doit pas être identique au nom du fichier"};
